...
#include"image.h"
// 引脚定义
#define NRST_PIN    4    // nRST
#define NDC_PIN     3    // nDC
#define CSB_PIN     2    // CSB (Master CS)
#define CSB2_PIN    1    // CSB2 (Slave CS)
#define MS_PIN      42   // MS
...
void ReadBusy(void) {
  unsigned long timeout = millis() + 10000; // 5秒超时
  while(1) {
    if(digitalRead(BUSY_PIN)) { // 高电平为空闲
